...
<head>
  ...
  <!--[if lt IE 9]>
  <script src="<?php echo site_url('assets/') ?>https://oss.maxcdn.com/html5shiv/3.7.3/html5shiv.min.js"></script>
  <script src="<?php echo site_url('assets/') ?>https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="<?php echo site_url('assets/') ?>#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="<?php echo site_url('assets/') ?>#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-envelope-o"></i>
              <span class="label label-success">4</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have 4 messages<?php echo base_url() ?><?php echo main_site_url() ?></li>
              <li>
              ...
              <li class="footer"><a href="<?php echo site_url('assets/') ?>#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo site_url('assets/') ?>#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer">
                <a href="<?php echo site_url('assets/') ?>#">View all tasks</a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo site_url('assets/') ?>#">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo site_url('assets/') ?>#">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo site_url('assets/') ?>#">Friends</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('assets/') ?>#" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo site_url('assets/') ?>#" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="<?php echo site_url('assets/') ?>#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="<?php echo site_url('assets/') ?>#"><i class="fa fa-circle text-success"></i> Online</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <?php include 'accordianmenu_sam.php' ?>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside> 
